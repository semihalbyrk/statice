...
> **Bağlam:** Statice Helden B.V. Hollanda'da WEEE (Waste Electrical and Electronic Equipment) ve diğer geri dönüşüm akışlarını işleyen bir MRF tesisidir. Inbound → Weighing → **Process** → Invoice/Outbound akışının **ikinci büyük aşaması** bu modüldür. "Process" aslında **iki ayrı alt-aşamadan** oluşur: (1) **Fase 1** (Catalogue / Materials — asset içeriğini materyal bazında kaydet), (2) **Fase 2** (Processing / Fractions — materyalleri fraksiyonlara ayır, işleme rotaları belirle). Fase 2 opsiyoneldir — bazı materyaller sadece Fase 1 ile tamamlanabilir.
...
║                                        ║
║  ┌─────────────────────────────────┐  ║
║  │ Fase 1: CATALOGUE (Materials)   │  ║
║  │ Asset (konteyner) → Material    │  ║
║  └─────────────────────────────────┘  ║
║                ↓                       ║
║  ┌─────────────────────────────────┐  ║
║  │ Fase 2: PROCESSING (Fractions)  │  ║
...
### 3.1 Fase 1: Catalogue (Materials) Aşaması
...
### 3.2 Fase 2: Processing (Fractions) Aşaması
...
### Adım 3: Fase 1 — Catalogue (Materials)
