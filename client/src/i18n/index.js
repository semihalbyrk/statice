  ...
  .init({
    resources: {
      en: {
        ...
        admin: adminEN, reports: reportsEN, arrival: arrivalEN, errors: errorsEN, entities: entitiesEN, outboundOrders: outboundOrdersEN, outbounds: outboundsEN, outboundLines: outboundLinesEN, parcels: parcelsEN,
      },
      nl: {
        ...
        admin: adminNL, reports: reportsNL, arrival: arrivalNL, errors: errorsNL, entities: entitiesNL, outboundOrders: outboundOrdersNL, outbounds: outboundsNL, outboundLines: outboundLinesNL, parcels: parcelsNL,
      },
    },
    fallbackLng: 'en',
    defaultNS: 'common',
